...
|status|[windowsUpdateStatus](../resources/intune-shared-windowsupdatestatus.md)|Windows update status. Possible values are: `upToDate`, `pendingInstallation`, `pendingReboot`, `failed`.|
